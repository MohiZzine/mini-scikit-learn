...
# Testing and Comparison with Scikit-Learn
...
def test():
    ...
    # Initialize and train our Random Forest Regressor
    custom_rf = RandomForestRegressor(n_estimators=100, random_state=42)
    custom_rf.fit(X_train, y_train)

    # Predictions and evaluation for the custom RandomForestRegressor
