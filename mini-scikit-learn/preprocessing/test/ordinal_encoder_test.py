# File: preprocessing/test/ordinal_encoder_test.py
...
class TestOrdinalEncoder(unittest.TestCase):
    ...
    def test_fit_transform(self):
        ...
        print("Fit Transform: OK" if np.array_equal(custom_encoded, sklearn_encoded) else "Fit Transform: WRONG")
    ...
    def test_inverse_transform(self):
      ...
      # Check inverse transform
        ...
        print("Inverse Transform: OK" if np.array_equal(custom_decoded, sklearn_decoded) else "Inverse Transform: WRONG")
